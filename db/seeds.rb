...
curry_de_crevettes_doux      = Recipe.create!(photo: File.open(Rails.root.join('db/fixtures/recipes/curry_de_crevettes_doux.jpg')), title: "Curry de crevettes doux", description: "J’ai découvert cette recette lors de mon dernier voyage en asie. Ce curry est extrêmement riche en protéines. Il est crémeux, savoureux, légèrement épicé et ne nécessite que 20 minutes de préparation. Rapide à préparer, fait maison et beaucoup plus sain que les plats à emporter. ", prep_time: "10 min", cook_time: "55 min", rest_time: "12 h", user: diane, kind: "original", published: true, published_on: 29/03/2019, servings: 4)
muesli_suisse                = Recipe.create!(photo: File.open(Rails.root.join('db/fixtures/recipes/muesli_suisse.jpg')), title: "Muesli Suisse", description: "Très prisé des sportifs, ce muesli riche en fibres. Etant donné qu'elles macèrent dans votre estomac, les graines de lin doivent toujours être consommées avec suffisamment de liquide. La consommation de graines de lin est particulièrement recommandée le matin, car elles stimulent le métabolisme et la digestion.", prep_time: "10 min", cook_time: "5 min", rest_time: "12 h", user: thierry, kind: "original", published: true, published_on: 29/03/2019, servings: 4)
...
Dose.create!(step: muesli_au_melange_de_baies_step_3, ingredient: graines_de_lin, quantity: 3à, unit: 'g')
