...
curry_de_crevettes_doux_variant_2_step_1   = Step.create!(recipe: curry_de_crevettes_doux, position: 1, content: "Couper la tomate en petits morceaux, peler et écraser les gousses d'ail, émincer les oignons et passer les gambas à la plancha 5 minutes.")
curry_de_crevettes_doux_variant_2_step_2   = Step.create!(recipe: curry_de_crevettes_doux, position: 2, content: "Dans une sauteuse ou un wok, chauffer l'huile. Mélanger ail, oignons et curry.")
curry_de_crevettes_doux_variant_2_step_3   = Step.create!(recipe: curry_de_crevettes_doux, position: 3, content: "Quand les oignons sont translucides, mettre la tomate, le lait de coco et le yaourt à la grecque. Saler, poivrer, mélanger, mettre un couvercle et laisser mijoter pendant 15 minutes.")
curry_de_crevettes_doux_variant_2_step_4   = Step.create!(recipe: curry_de_crevettes_doux, position: 4, content: "Rajouter les gambas et laisser cuire pendant 2 à 3 minutes. Servir avec du riz.")
...
cake_citron_graines_pavot_variant_3    = Recipe.create!(photo: File.open(Rails.root.join('db/fixtures/recipes/mini_cakes_au_citron.jpg')), title: "Cake au citron et graines de pavot", subtitle: "Version mini et sans graines de pavot", description: "Et voici une version mini, à partager et à emporter ! Et comme je ne suis pas très graines de pavot, j'ai fait sans.", prep_time: "10 min", cook_time: "55 min", rest_time: "12 h", kind: "variant", published: true, user: thierry, original_recipe: cake_citron_graines_pavot)
